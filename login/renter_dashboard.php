    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color:white">
           <ul class="nav">
            <li class="nav-item nav-category active"><a class="nav-link" href="renter_dashboard.php"><span class="nav-link text-light">DASHBOARD</span></a></li>
          ...
          <div class="content-wrapper">
            <div class="row">
              <?php
                ...
                $sql = "SELECT * FROM room_details WHERE room_status = 1";
              ...
              <div class="col-md-4 grid-margin">
                <div class="card" style="height: 680px;">
                  <span class="card-title"><h2 class="mt-3 text-center text-success"><strong> AVAILABLE </strong></h2> </span>
                  <div class="card-body">
                     <img src="../images/<?php echo $row['room_img']?>" style="width:300px;height:200px; padding-right: 20px;" alt="">
                    <h4 class="card-title text-center">Room Number: <?php echo $row['room_number']; ?></h4>
                   ...
                   <div class="card-footer">
                     <div class="row"> 
                         <a href="renter_bookroom.php?roomID=<?php echo $row['room_id']?>" class="btn btn-primary btn-md mx-5 my-2"><h4>BOOK ROOM</h4></a>
                    </div>
                   </div>
                </div>
              </div>
