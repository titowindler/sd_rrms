      ...
      <div class="container-fluid page-body-wrapper">
        <!-- partial:partials/_sidebar.html -->
          ...
          <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color:white">
           <ul class="nav">
            <li class="nav-item nav-category"><a class="nav-link" href="tenant_dashboard.php"><span class="nav-link text-dark">DASHBOARD</span></a></li>
            <li class="nav-item nav-category active"><a class="nav-link" href="tenant_view_agreement.php"><span class="nav-link text-light">VIEW AGREEMENT</span></a></li>
            <li class="nav-item nav-category"><a class="nav-link" href="tenant_view_profile.php"><span class="nav-link text-dark">VIEW PROFILE</span></a></li>
           </ul>
        </nav>
        <!-- partial -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              while($row = mysqli_fetch_assoc($resultGetAgreement)) {
                ...
                $collection_of_rental = $row['collection_of_rental'];
              }
                 ...
                 <div class="card-body">
                    <form class="forms-sample">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputUsername1" value="<?php echo $name_of_occupant?>" disabled>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $emailaddress?>" disabled>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" value="<?php echo $mobile_number?>" disabled>
                      </div>
                       <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="exampleInputConfirmPassword1" value="<?php echo $date_occupied?>" disabled>
                      </div>
                       <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Collection of Rental</label>
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" value="<?php echo $collection_of_rental?>" disabled>
                      </div>
                  </form>
...
<!-- Add Subject Modal -->
        ...
        <?php require("modal-listdropdown-tenant.php"); ?>
