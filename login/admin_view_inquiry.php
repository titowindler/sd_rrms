      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color:white">
          <ul class="nav">
            ...
            <li class="nav-item nav-category"><a class="nav-link" href="admin_view_tenant.php"><span class="nav-link text-dark">TENANTS</span></a></li>
            <li class="nav-item nav-category active"><a class="nav-link" href="admin_view_inquiry.php"><span class="nav-link text-light">INQUIRY</span></a></li>
          </ul>
        </nav>
        <!-- partial -->
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      $sqlInquiry = "SELECT * FROM inquiry";
                      $resultInquiry = mysqli_query($conn,$sqlInquiry);

                      while($rowInquiry = mysqli_fetch_assoc($resultInquiry)) {
                      ?>
                          <tr>
                           <td> <?php echo $rowInquiry['inquiry_date'];?> </td>
                           <td> <?php echo $rowInquiry['inquiry_firstname'];?> <?php echo $rowInquiry['inquiry_lastname'];?> </td>
                           <td> <?php echo $rowInquiry['inquiry_emailaddress'];?> </td>
                           <td> <?php echo $rowInquiry['inquiry_phonenumber'];?> </td>
                          </tr>
                        <?php } ?>
                        </tbody>
                    </table>
