        ...
        <!-- partial:partials/_sidebar.html -->
          ...
          <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color:white">
           <ul class="nav">
            ...
            <li class="nav-item nav-category"><a class="nav-link" href="tenant_view_agreement.php"><span class="nav-link text-dark">VIEW AGREEMENT</span></a></li>
            <li class="nav-item nav-category active"><a class="nav-link" href="tenant_view_profile.php"><span class="nav-link text-light">VIEW PROFILE</span></a></li>
           </ul>
        </nav>
        <!-- partial -->
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              $sqlGetAgreement = "SELECT * FROM tenant 
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                 <div class="card-body">
                    <form class="forms-sample" method="POST" action="../function/profile.php">

                      <input type="hidden" value="<?php echo $tenantID ?>" name="tenantID">

                      <div class="form-group">
                        <label for="exampleInputUsername1">Tenant Firstname</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" value="<?php echo $firstname?>" name="fname">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Tenant Lastname</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $lastname?>" name="lname">
                      </div>
                       <button type="submit" class="btn btn-success btn-md mr-2" name="editProfileFunc">Submit</button>
                      </form>
