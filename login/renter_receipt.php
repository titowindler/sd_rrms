              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <table class="table table-bordered">
                      ...
                      $sqlRooms = "SELECT * FROM receipt_details receipt
                      JOIN pay_details pay ON
                      receipt.pay_id = pay.pay_id 
                      WHERE pay.user_id = '$renterID'
                      ";
                      ...
                      ?>
                        <tr>
                          <td> <?php echo $rowRooms['receipt_id']; ?> </td>
                          <td> <?php echo $rowRooms['pay_date']; ?> </td>
                          <td> <?php echo $rowRooms['pay_message']; ?> </td>
                         </tr>
