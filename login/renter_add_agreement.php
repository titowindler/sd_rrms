              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                 ...
                 <?php 
                      ...
                      WHERE booking.booking_id = '$book_id';
                      ;
                      ";
                      
                      $resultRooms = mysqli_query($conn,$sqlRooms);

                      $rowBook = mysqli_fetch_assoc($resultRooms);
                 ...
                 <div class="card-body">
                    <form class="forms-sample" action="../function/agreement.php" method="POST">
                      ...
                      <input type="hidden" value="<?php echo $book_id?>" name="bookID"> 
                       ...
                       <input type="hidden" value="<?php echo $rowBook['startDate']?>" name="startDate">

                        <input type="hidden" value="<?php echo $rowBook['endDate']?>" name="endDate">

                         <input type="hidden" value="<?php echo $rowBook['room_price']?>" name="rental_rate">
                    ...
                    <!--   <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" value="<?php echo $rowBook['room_price']?>" disabled>
                      </div>


                       <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Start Date</label>
                        <input type="date" class="form-control" id="exampleInputConfirmPassword1"  value="<?php echo $rowBook['startDate']?>" disabled >
                      </div>


                       <div class="form-group">
                        <label for="exampleInputConfirmPassword1">End Date</label>
                        <input type="date" class="form-control" id="exampleInputConfirmPassword1"  value="<?php echo $rowBook['endDate']?>" disabled>
                      </div>
